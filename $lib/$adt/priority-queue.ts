import { BinaryHeap, type IBinaryHeap } from "../$ds/binary-heap.js";
...
export abstract class PriorityQueue<T> implements IPriorityQueue<T> {
    constructor(
        public isOrdered: (a: T, b: T) => boolean = (a: T, b: T) => a < b,
    ) {
        this.queue = new BinaryHeap<Keyed<T>>((a: Keyed<T>, b: Keyed<T>) =>
...
export class MaxPriorityQueue<T> extends PriorityQueue<T>
    ...
    constructor(
        isOrdered: (a: T, b: T) => boolean = (a: T, b: T) => a < b,
    ) {
