import {
    nChooseRCombinations,
    nChooseRPermutations,
    nCr,
    nPr,
...
describe("Permutations", () => {
    ...
    test("5 choose 1 permutations", () => {
        expect(nChooseRPermutations(["a", "b", "c", "d", "e"], 1))
            .toStrictEqual([
                ["a"],
                ["b"],
                ["c"],
    ...
    test("5 choose 2 permutations", () => {
        expect(nChooseRPermutations(["a", "b", "c", "d", "e"], 2))
            .toStrictEqual([
                ["a", "b"],
                ["a", "c"],
                ["a", "d"],
    ...
    test("5 choose 3 permutations", () => {
        expect(nChooseRPermutations(["a", "b", "c", "d", "e"], 3))
            .toStrictEqual([
                ["a", "b", "c"],
                ["a", "b", "d"],
                ["a", "b", "e"],
...
describe("Combinations", () => {
    ...
    test("5 choose 1 combinations", () => {
        expect(nChooseRCombinations(["a", "b", "c", "d", "e"], 1))
            .toStrictEqual([
                ["a"],
                ["b"],
                ["c"],
    ...
    test("5 choose 2 combinations", () => {
        expect(nChooseRCombinations(["a", "b", "c", "d", "e"], 2))
            .toStrictEqual([
                ["a", "b"],
                ["a", "c"],
                ["a", "d"],
    ...
    test("5 choose 3 combinations", () => {
        expect(nChooseRCombinations(["a", "b", "c", "d", "e"], 3))
            .toStrictEqual([
                ["a", "b", "c"],
                ["a", "b", "d"],
                ["a", "b", "e"],
